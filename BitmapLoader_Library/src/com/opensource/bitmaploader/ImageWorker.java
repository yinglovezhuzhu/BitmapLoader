...
public abstract class ImageWorker {
     ...
     * {@link com.opensource.bitmaploader.ImageWorker#setImageCache(ImageCache)}. If the image is found in the memory cache, it
     * is set immediately, otherwise an {@link android.os.AsyncTask} will be created to asynchronously load the
     * bitmap. {@link com.opensource.bitmaploader.ImageWorker#setAdapter(ImageWorkerAdapter)} must be called before using this
     * method.
     *
     ...
     * {@link com.opensource.bitmaploader.ImageWorker#setImageCache(ImageCache)}. If the image is not found in the memory or disk cache, it
     ...
     * {@link com.opensource.bitmaploader.ImageWorker#setImageCache(ImageCache)}. If the image is not found in the memory or disk cache, <br>
