...
public abstract class AsyncTask<Params, Progress, Result> {
            ...
            protected void done() {
                ...
                try {
                    ...
                    message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
                            new AsyncTaskExResult<Result>(AsyncTask.this, (Result[]) null));
                ...
                message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
                        new AsyncTaskExResult<Result>(AsyncTask.this, result));
                message.sendToTarget();
            }
        };
    }
     ...
     *                               {@link com.opensource.bitmaploader.AsyncTask.Status#RUNNING} or {@link com.opensource.bitmaploader.AsyncTask.Status#FINISHED}.
     */
    ...
    private static class AsyncTaskExResult<Data> {
        ...
        AsyncTaskExResult(AsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
