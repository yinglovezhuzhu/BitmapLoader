...
public abstract class AsyncTaskEx<Params, Progress, Result> {
     ...
     *                               {@link com.opensource.bitmaploader.AsyncTaskEx.Status#RUNNING} or {@link com.opensource.bitmaploader.AsyncTaskEx.Status#FINISHED}.
     */
    @SuppressWarnings("incomplete-switch")
    public final AsyncTaskEx<Params, Progress, Result> execute(@SuppressWarnings("unchecked") Params... params) {
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link com.opensource.bitmaploader.AsyncTaskEx#onPostExecute} has finished.
         */
        FINISHED,
    }
    ...
    private static class AsyncTaskExResult<Data> {
        ...
        AsyncTaskExResult(AsyncTaskEx task, @SuppressWarnings("unchecked") Data... data) {
            mTask = task;
            mData = data;
        }
    }
