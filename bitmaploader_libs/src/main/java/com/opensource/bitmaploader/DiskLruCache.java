...
public class DiskLruCache {
     ...
     * {@link com.opensource.bitmaploader.DiskLruCache#openCache(android.content.Context, java.io.File, long)} which runs some extra checks before
     ...
     * call {@link com.opensource.bitmaploader.DiskLruCache#clearCache(android.content.Context, String)} or {@link com.opensource.bitmaploader.DiskLruCache#clearCache()}
     * instead.
     *
    ...
    /**
     * Get a usable cache directory.(If the custom directory exist or it can be created, get the custom directory, otherwise, get the system cache directory {@link com.opensource.bitmaploader.DiskLruCache#getSystemCacheDir(android.content.Context)})
     *
     * @param context
     * @param cachePath
     * @param uniqueName
    ...
    /**
     * Writes a bitmap to a file. Call {@link com.opensource.bitmaploader.DiskLruCache#setCompressParams(android.graphics.Bitmap.CompressFormat, int)}
